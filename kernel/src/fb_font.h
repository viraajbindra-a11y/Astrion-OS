 ...
 * in kernel_mb2.c. font_data[char_index][row] is an 8-bit bitmap
 * row (MSB = leftmost column).
 *
 * 95 chars * 12 rows = 1140 bytes of constant data.
 */

#ifndef ASTRION_FB_FONT_H
#define ASTRION_FB_FONT_H
